...
function receiveResponseCallback(response) {
    ...
    response.on('end', function (chunk) {
        ...
        let taux = JSON.parse(rawData);

        // On affiche l'objet JSON
        console.log("La valeur de 1$ en €. " + taux.eur.rate + " La valeur de 1€ en $. " + taux.eur.inverseRate);
        console.log("La valeur de 100$ en €. " + (taux.eur.rate * 100) + " La valeur de 100€ en $. " + (taux.eur.inverseRate * 100));
        // console.log(rawData);
    });
};
